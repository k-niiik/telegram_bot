##  Telegram-bot
**Этот Telegram-бот предназначен для распознавания человека по лицу, а также для записи видео, на котором присутствует человек. 	 Данный Telegram - бот был разработан в рамках Всероссийского конкурса юных инженеров-исследователей с международным участием "Спутник".** <br> Пример работы бота можно увидеть [**здесь**](https://drive.google.com/file/d/1L_IFnl7tK-4JoSc_-NSTsTO99IKwSgCZ/view?usp=sharing). <br>  Видео, полученные в результате тестирование программы, можно посмотреть по следующим ссылкам: <br> - [**тест**](https://drive.google.com/drive/folders/1svSNLFey7MoteXX_0UkKtQKMDsHRh4Un?usp=sharing) на качество работы программы при разной освещенности; <br> - [**тест**](https://drive.google.com/drive/folders/1exVvradjLlXbKHfWX9KdC4vJdfDg7S67?usp=sharing) на количество людей, которое программа может распознать одновременно; <br> - [**тест**](https://drive.google.com/drive/folders/1a2esbmUGcqUba3w_0scBgaGWBdbQGhUo?usp=sharing) на проверку записанных кадров, на которых есть человек.
...
# 2. Работа с кодом программы.
   ...
   нужно ввести токен, который прислал BotFather.  
    ...
    Копию проекта со всеми уже созданными файлами можно скачать по [**ссылке**](https://drive.google.com/drive/folders/1RTP4iYQz7pq0YS1dBxIOX5oFo68KMJRM?usp=sharing) <br>
